...
export default function accounts() {
  return (
    <View className="flex-1 justify-start pt-4 items-center bg-[#ffffff84] ">
      {/* my accounts and add acount button */}
      <View className="flex-row justify-center gap-[240px] border-b border-[#0C4C7B1A] pb-4 items-center w-full mx-auto ">
    ...
    <View className="bg-white w-[355px] h-[80px] mx-auto my-4 rounded-[12px] flex-row justify-between items-center px-5">
      <View className=" flex-row gap-2 w-[165px] h-[80px] justify-end items-center  ">
        ...
        <View className="">
          ...
          {ver ? (
            <Text className="font-bold text-[#34C759DE] text-[10px] ">Verified</Text>
          ) : (
            <Text className="font-bold  text-[#F0133BE0] text-[10px] ">Unverified</Text>
          )}
        </View>
      </View>
