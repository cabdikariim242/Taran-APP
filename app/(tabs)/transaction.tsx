...
export default function transaction() {
  return (
    <View className="flex-1  justify-start w-full   relative items-center bg-[#ffffff84]">
      {/* the top bar icon and text */}
      <View className="flex-row justify-center gap-[190px] border-b border-[#0C4C7B1A] pb-4 items-center w-full mx-auto ">
        {/* IMG AND TEXT */}
